...
# Verifies the git flow structure: develop, feature, release, tag.
...
# 9.6 release/1.0 exists on remote
assert_contains "release/1.0 exists on remote" "$remote_branches" "origin/release/1.0"
...
# 9.8 feature/gitflow-demo is merged into develop
merged_into_develop=$(ssh_vm "cd ~/workspace && git branch --merged develop")
assert_contains "feature/gitflow-demo is merged into develop" "$merged_into_develop" "feature/gitflow-demo"
